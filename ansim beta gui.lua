...
local Window = Library.CreateLib("Animal Simulator script v0", "RJTheme3")
...
Section6:NewTextBox("SpeedHack Default: 16", "SliderInfo", function(wshack)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = wshack
end)
Section6:NewTextBox("JumpHack Default: 50", "SliderInfo", function(jphack)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = jphack
end)
Section5:NewTextBox("FPS Cap Default: 60", "SliderInfo", function(fpscap)
    setfpscap(fpscap)
end)
